    ...
    <Layout titulo="Hojas de Ruta">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">
            {isLoading ? (
              ...
              <>
                {total} {total === 1 ? 'hoja registrada' : 'hojas registradas'}
                {filtrosActivos > 0 && (
                  <span className="ml-2 text-primary-700 font-medium">
            ...
            {filtrosActivos > 0 && (
              <div className="flex justify-end mt-4">
                <button
                  ...
                  className="text-sm text-neutral-500 hover:text-accent-600 flex items-center gap-1.5"
                >
                  <X className="w-4 h-4" />
      ...
      {isLoading ? (
        <div className="card text-center py-12">
          ...
          <p className="mt-4 text-neutral-500">Cargando hojas de ruta...</p>
        </div>
      ) : hojas.length === 0 ? (
        <div className="card text-center py-12">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={pagina === 1}
                  className="p-2 rounded-lg border border-neutral-300 hover:bg-neutral-50 disabled:opacity-40 disabled:cursor-not-allowed"
                  title="Anterior"
                >
